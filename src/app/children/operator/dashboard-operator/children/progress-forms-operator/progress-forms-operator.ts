...
@Component({
    selector: 'app-progress-forms-operator',
    imports: [
        FormsTable,
    ],
    templateUrl: './progress-forms-operator.html',
    styleUrl: './progress-forms-operator.css',
})
export class ProgressFormsOperator implements OnInit {
