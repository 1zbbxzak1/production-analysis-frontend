...
@Component({
    selector: 'app-completed-forms-operator',
    imports: [
        FormsTable,
    ],
    templateUrl: './completed-forms-operator.html',
    styleUrl: './completed-forms-operator.css',
})
export class CompletedFormsOperator implements OnInit {
