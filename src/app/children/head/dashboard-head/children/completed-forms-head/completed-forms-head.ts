...
@Component({
    selector: 'app-completed-forms-head',
    imports: [
        FormsTable
    ],
    templateUrl: './completed-forms-head.html',
    styleUrl: './completed-forms-head.css',
})
export class CompletedFormsHead implements OnInit {
