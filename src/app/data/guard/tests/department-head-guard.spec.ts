...
describe('departmentHeadGuard', (): void => {
    const executeGuard: CanActivateFn = (...guardParameters) =>
        TestBed.runInInjectionContext(() => departmentHeadGuard(...guardParameters));
    ...
    it('should return false and redirect to home when user does not have DepartmentHead role', (done: DoneFn): void => {
        mockAuthManagerService.getAccessToken.and.returnValue('valid-token');
        mockAuthManagerService.getUserRoles.and.returnValue(['Operator', 'Admin']);
    ...
    it('should return true when user has DepartmentHead role among multiple roles', (done: DoneFn): void => {
        mockAuthManagerService.getAccessToken.and.returnValue('valid-token');
