...
describe('adminGuard', (): void => {
    ...
    it('should return false and redirect to home when user does not have Admin role', (done: DoneFn): void => {
    ...
    it('should return true when user has Admin role among multiple roles', (done: DoneFn): void => {
        mockAuthManagerService.getAccessToken.and.returnValue('valid-token');
        mockAuthManagerService.getUserRoles.and.returnValue(['Operator', 'Admin', 'DepartmentHead']);
